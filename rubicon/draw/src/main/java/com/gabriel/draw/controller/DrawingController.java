...
import com.gabriel.draw.model.Ellipse;        // Add this import
import com.gabriel.draw.model.Rectangle;      // Add this import
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (appService.getDrawMode() == DrawMode.Idle) {
            ...
            if (appService.getShapeMode() == ShapeMode.Line) {
                ...
                currentShape = new Ellipse(start, 0, 0);
            } else if (appService.getShapeMode() == ShapeMode.Rectangle) {
                currentShape = new Rectangle(start, 0, 0);
            }
